...
│   ├── init-decision-log.md   # 决策讨论全过程（冲突与决议）
│   ├── adr/                   # 架构决策记录
│   │   ├── 001-rust-over-swift.md
│   │   ├── 002-openai-protocol.md
│   │   ├── 003-tauri-single-process.md
│   │   └── 004-react-typescript.md
│   └── planning/              # 执行计划（待生成 PLAN.md）
...
已归档的架构决策记录见 `docs/adr/`，讨论过程见 `docs/init-decision-log.md`：
...
- 决策讨论全过程：`docs/init-decision-log.md`
